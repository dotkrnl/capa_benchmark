...
static __dst_alloc_bucket_size_t __dst_alloc_bucket_for_request__dmemL104R(
...
static void __dst_alloc_list_push__dmemL104R(
    ...
    if (prev == 0) __dst_alloc_buckets__dmemL104R[bucket].next = entry;
    else __dmemL104R[prev]._link.next = entry;
    __dst_alloc_buckets__dmemL104R[bucket].prev = entry;
}
static void __dst_alloc_list_remove__dmemL104R(
        __dst_alloc_bucket_size_t bucket,
        __dst_alloc_size_t entry) {
    __dst_alloc_size_t prev = __dmemL104R[entry]._link.prev;
    __dst_alloc_size_t next = __dmemL104R[entry]._link.next;
    if (prev == 0) __dst_alloc_buckets__dmemL104R[bucket].next = next;
    else __dmemL104R[prev]._link.next = next;
    if (next == 0) __dst_alloc_buckets__dmemL104R[bucket].prev = prev;
    else __dmemL104R[next]._link.prev = prev;
}
static __dst_alloc_size_t __dst_alloc_list_pop__dmemL104R(
        __dst_alloc_bucket_size_t bucket) {
...
static __dst_alloc_size_t __dst_alloc_index_for_node__dmemL104R(
        __dst_alloc_size_t bucket_index,
        __dst_alloc_bucket_size_t bucket) {
    return 1 + ((bucket_index - (1 << bucket) + 1) << (ARRAY_LOG - bucket));
}
static __dst_alloc_size_t __dst_alloc_node_for_index__dmemL104R(
...
__dst_alloc_size_t __dst_alloc_malloc__dmemL104R(__dst_alloc_size_t request) {
    request = request / sizeof(::node);
    if (request > (1 << ARRAY_LOG)) return 0;
    __dst_alloc_bucket_size_t bucket =
        __dst_alloc_bucket_for_request__dmemL104R(request);
    ...
    while ((__dst_alloc_bucket_size_t)(bucket + 1) != 0) {
        ...
        if (i != 0) __dst_alloc_flip_parent_split__dmemL104R(i);
...
void __dst_alloc_free__dmemL104R(__dst_alloc_size_t ptr) {
    ...
    ptr -= 1;
    __dst_alloc_bucket_size_t bucket =
        __dst_alloc_bucket_for_request__dmemL104R(__dmemL104R[ptr]._link.prev);
    __dst_alloc_size_t i = __dst_alloc_node_for_index__dmemL104R(ptr, bucket);
    while (i != 0) {
        __dst_alloc_flip_parent_split__dmemL104R(i);
        if (__dst_alloc_test_parent_split__dmemL104R(i)) break;
...
void insert(__didxL104R newitem,__didxL104R root)
{
  ...
  if ((&(__dmemL104R + __rect_packed_var_L1202R__L1203R[0 + __rect_packed_top_L1202R__L1203R] . local0 + 0U - 1U) -> _data) -> value > (&(__dmemL104R + __rect_packed_var_L1202R__L1203R[0 + __rect_packed_top_L1202R__L1203R] . local1 + 0U - 1U) -> _data) -> value) {
    if ((&(__dmemL104R + __rect_packed_var_L1202R__L1203R[0 + __rect_packed_top_L1202R__L1203R] . local1 + 0U - 1U) -> _data) -> right == 0L) 
      (&(__dmemL104R + __rect_packed_var_L1202R__L1203R[0 + __rect_packed_top_L1202R__L1203R] . local1 + 0U - 1U) -> _data) -> right = __rect_packed_var_L1202R__L1203R[0 + __rect_packed_top_L1202R__L1203R] . local0;
     else {
      __rect_packed_var_L1202R__L1203R[0 + __rect_packed_top_L1202R__L1203R] . _location = 2U;
      __rect_packed_var_L1202R__L1203R[1 + __rect_packed_top_L1202R__L1203R] . local1 = (&(__dmemL104R + __rect_packed_var_L1202R__L1203R[0 + __rect_packed_top_L1202R__L1203R] . local1 + 0U - 1U) -> _data) -> right;
      ...
      ++__rect_packed_top_L1202R__L1203R;
      if (__rect_packed_top_L1202R__L1203R == 1 << ARRAY_LOG) 
        g_fallback = true;
      0;
      __rect_packed_var_L1202R__L1203R[0 + __rect_packed_top_L1202R__L1203R] . _location = 1U;
      goto __rect_func_L1_L1202R__L1203R;
  ...
  if ((&(__dmemL104R + __rect_packed_var_L1202R__L1203R[0 + __rect_packed_top_L1202R__L1203R] . local0 + 0U - 1U) -> _data) -> value < (&(__dmemL104R + __rect_packed_var_L1202R__L1203R[0 + __rect_packed_top_L1202R__L1203R] . local1 + 0U - 1U) -> _data) -> value) {
    if ((&(__dmemL104R + __rect_packed_var_L1202R__L1203R[0 + __rect_packed_top_L1202R__L1203R] . local1 + 0U - 1U) -> _data) -> left == 0L) 
      (&(__dmemL104R + __rect_packed_var_L1202R__L1203R[0 + __rect_packed_top_L1202R__L1203R] . local1 + 0U - 1U) -> _data) -> left = __rect_packed_var_L1202R__L1203R[0 + __rect_packed_top_L1202R__L1203R] . local0;
     else {
      __rect_packed_var_L1202R__L1203R[0 + __rect_packed_top_L1202R__L1203R] . _location = 3U;
      __rect_packed_var_L1202R__L1203R[1 + __rect_packed_top_L1202R__L1203R] . local1 = (&(__dmemL104R + __rect_packed_var_L1202R__L1203R[0 + __rect_packed_top_L1202R__L1203R] . local1 + 0U - 1U) -> _data) -> left;
      __rect_packed_var_L1202R__L1203R[1 + __rect_packed_top_L1202R__L1203R] . local0 = __rect_packed_var_L1202R__L1203R[0 + __rect_packed_top_L1202R__L1203R] . local0;
      ++__rect_packed_top_L1202R__L1203R;
      if (__rect_packed_top_L1202R__L1203R == 1 << ARRAY_LOG) 
        g_fallback = true;
...
void dfs_traverse(__didxL104R root)
{
  ...
  if ((&(__dmemL104R + __rect_packed_var_L1204R__L1205R[0 + __rect_packed_top_L1204R__L1205R] . local0 + 0U - 1U) -> _data) -> left != 0L) {
    ...
    ++__rect_packed_top_L1204R__L1205R;
    if (__rect_packed_top_L1204R__L1205R == 1 << ARRAY_LOG) 
      g_fallback = true;
    0;
    __rect_packed_var_L1204R__L1205R[0 + __rect_packed_top_L1204R__L1205R] . _location = 1U;
    goto __rect_func_L1_L1204R__L1205R;
