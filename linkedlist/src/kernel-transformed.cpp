...
static __dst_alloc_bucket_size_t __dst_alloc_bucket_for_request__dmemL105R(__dst_alloc_size_t request)
{
...
static void __dst_alloc_list_push__dmemL105R(__dst_alloc_bucket_size_t bucket,__dst_alloc_size_t entry)
{
  ...
  if (prev == 0) 
    __dst_alloc_buckets__dmemL105R[bucket] . next = entry;
   else 
    __dmemL105R[prev] . _link . next = entry;
  __dst_alloc_buckets__dmemL105R[bucket] . prev = entry;
}

static void __dst_alloc_list_remove__dmemL105R(__dst_alloc_bucket_size_t bucket,__dst_alloc_size_t entry)
{
  __dst_alloc_size_t prev = __dmemL105R[entry] . _link . prev;
  __dst_alloc_size_t next = __dmemL105R[entry] . _link . next;
  if (prev == 0) 
    __dst_alloc_buckets__dmemL105R[bucket] . next = next;
   else 
    __dmemL105R[prev] . _link . next = next;
  if (next == 0) 
    __dst_alloc_buckets__dmemL105R[bucket] . prev = prev;
   else 
    __dmemL105R[next] . _link . prev = prev;
}

static __dst_alloc_size_t __dst_alloc_list_pop__dmemL105R(__dst_alloc_bucket_size_t bucket)
{
...
static __dst_alloc_size_t __dst_alloc_index_for_node__dmemL105R(__dst_alloc_size_t bucket_index,__dst_alloc_bucket_size_t bucket)
{
  return 1 + (bucket_index - (1 << bucket) + 1 << ARRAY_LOG - bucket);
}

static __dst_alloc_size_t __dst_alloc_node_for_index__dmemL105R(__dst_alloc_size_t global_index,__dst_alloc_bucket_size_t bucket)
{
...
unsigned int __dst_alloc_malloc__dmemL105R(__dst_alloc_size_t request)
{
  request = (request / sizeof(NODE ));
  if (request > (1 << ARRAY_LOG)) 
    return 0;
  __dst_alloc_bucket_size_t bucket = __dst_alloc_bucket_for_request__dmemL105R(request);
...
void __dst_alloc_free__dmemL105R(__dst_alloc_size_t ptr)
{
  if (ptr == 0) 
    return ;
  ptr -= 1;
  __dst_alloc_bucket_size_t bucket = __dst_alloc_bucket_for_request__dmemL105R(__dmemL105R[ptr] . _link . prev);
  __dst_alloc_size_t i = __dst_alloc_node_for_index__dmemL105R(ptr,bucket);
  while(i != 0){
    __dst_alloc_flip_parent_split__dmemL105R(i);
    if ((__dst_alloc_test_parent_split__dmemL105R(i))) 
      break; 
...
struct __rect_packed_type_L1235R__L1236R 
{
  __didxL105R local0;
  __didxL105R local1;
  __didxL105R local2;
...
{
  volatile struct __rect_packed_type_L1235R__L1236R __rect_packed_var_L1235R__L1236R[1 << ARRAY_LOG];
  volatile unsigned int __rect_packed_top_L1235R__L1236R = 0U;
  __rect_packed_var_L1235R__L1236R[0 + __rect_packed_top_L1235R__L1236R] . _location = 1U;
  __rect_packed_var_L1235R__L1236R[0 + __rect_packed_top_L1235R__L1236R] . local0 = ptr;
  __rect_packed_var_L1235R__L1236R[0 + __rect_packed_top_L1235R__L1236R] . local1 = previous;
  ++__rect_packed_top_L1235R__L1236R;
  __rect_func_L0_L1235R__L1236R:
  if (0U == __rect_packed_top_L1235R__L1236R) 
    return __rect_packed_var_L1235R__L1236R[0 + __rect_packed_top_L1235R__L1236R] . _return;
  --__rect_packed_top_L1235R__L1236R;
  if (1U == __rect_packed_var_L1235R__L1236R[0 + __rect_packed_top_L1235R__L1236R] . _location) 
    goto __rect_func_L1_L1235R__L1236R;
  if (2U == __rect_packed_var_L1235R__L1236R[0 + __rect_packed_top_L1235R__L1236R] . _location) 
    goto __rect_func_L2_L1235R__L1236R;
  __rect_func_L1_L1235R__L1236R:
  __didxL105R temp;
  if (((&(__dmemL105R + __rect_packed_var_L1235R__L1236R[0 + __rect_packed_top_L1235R__L1236R] . local0 + 0U - 1U) -> _data) -> next) == 0L) {
    (&(__dmemL105R + __rect_packed_var_L1235R__L1236R[0 + __rect_packed_top_L1235R__L1236R] . local0 + 0U - 1U) -> _data) -> next = __rect_packed_var_L1235R__L1236R[0 + __rect_packed_top_L1235R__L1236R] . local1;
    __rect_packed_var_L1235R__L1236R[0 + __rect_packed_top_L1235R__L1236R] . _return = __rect_packed_var_L1235R__L1236R[0 + __rect_packed_top_L1235R__L1236R] . local0;
    goto __rect_func_L0_L1235R__L1236R;
  }
   else {
    if (__rect_packed_top_L1235R__L1236R + 1U == 1 << ARRAY_LOG) 
g_fallback = true;
      0;
    __rect_packed_var_L1235R__L1236R[0 + __rect_packed_top_L1235R__L1236R] . _location = 2U;
    __rect_packed_var_L1235R__L1236R[1 + __rect_packed_top_L1235R__L1236R] . local1 = __rect_packed_var_L1235R__L1236R[0 + __rect_packed_top_L1235R__L1236R] . local0;
    __rect_packed_var_L1235R__L1236R[1 + __rect_packed_top_L1235R__L1236R] . local0 = (&(__dmemL105R + __rect_packed_var_L1235R__L1236R[0 + __rect_packed_top_L1235R__L1236R] . local0 + 0U - 1U) -> _data) -> next;
    ++__rect_packed_top_L1235R__L1236R;
    __rect_packed_var_L1235R__L1236R[0 + __rect_packed_top_L1235R__L1236R] . _location = 1U;
    goto __rect_func_L1_L1235R__L1236R;
    __rect_func_L2_L1235R__L1236R:
    __rect_packed_var_L1235R__L1236R[0 + __rect_packed_top_L1235R__L1236R] . __rect_packed_type_L1235R__L1236R::_ret0 = (__rect_packed_var_L1235R__L1236R[1 + __rect_packed_top_L1235R__L1236R] . _return);
    __rect_packed_var_L1235R__L1236R[0 + __rect_packed_top_L1235R__L1236R] . local2 = __rect_packed_var_L1235R__L1236R[0 + __rect_packed_top_L1235R__L1236R] . __rect_packed_type_L1235R__L1236R::_ret0;
    (&(__dmemL105R + __rect_packed_var_L1235R__L1236R[0 + __rect_packed_top_L1235R__L1236R] . local0 + 0U - 1U) -> _data) -> next = __rect_packed_var_L1235R__L1236R[0 + __rect_packed_top_L1235R__L1236R] . local1;
    __rect_packed_var_L1235R__L1236R[0 + __rect_packed_top_L1235R__L1236R] . _return = __rect_packed_var_L1235R__L1236R[0 + __rect_packed_top_L1235R__L1236R] . local2;
    goto __rect_func_L0_L1235R__L1236R;
  }
  goto __rect_func_L0_L1235R__L1236R;
}
